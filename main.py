...
В каждом объекте есть имя и фамилия студента, а также список оценок (целых чисел).
Нужно написать функцию get_best_students, которая берёт студентов и находит того,
у кого средний балл наибольший. Возвращает функция список студентов с лучшим баллом.
У некоторых студентов в оценкахесть None: их среднюю оценку мы считаем равной 0.
'''
